...
To make Brownlow's profits closest to 0 we altered the odds and the class size. By altering the odds to 4.3868 we got his payout near to 0. By altering the class size we got the average profit closest to 0 by making the class size 28. By modyfing the odds we were able to get the profits closer to 0 than by motifying the class size. Brownlow's odds must be 4.3868 in order to make the bet fair.
